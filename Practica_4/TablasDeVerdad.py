...
import TablasDeVerdad_epy_block_0 as epy_block_0  # embedded python block
import math
...
class TablasDeVerdad(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TablasDeVerdad")
        ...
        labels = ['EC-Re', 'Ec-Ima', 'Signal 3', 'Signal 4', 'Signal 5',
...
def main(top_block_cls=TablasDeVerdad, options=None):
